...
EXAMPLE_COMMANDS = {'config':{'open':[{'example':'config open myconfig',
                              ...
                              'experiment':[{'example':'cognitive-sources=[eye-tracking_zuco] embeddings=[glove.6B.50] rand-embeddings=True',
                                            ...
                                            {'example':'cognitive-sources=[eeg_zuco, eeg_ucl] embeddings=[glove.6B.50, glove.6B.100] rand-embeddings=True single-edit=True',
                                             ...
                                             {'example':'modalities=[eeg] embeddings=[glove.6B.50] rand-embeddings=True',
                                             ...
                                             {'example':'cognitive-sources=[all] embeddings=[glove.6B.50] rand-embeddings=True',
                                             ...
                                             {'example':'cognitive-sources=[eeg_zuco] embeddings=[all] rand-embeddings=True',
                    ...
                    'run':[{'example':'demo',
                            ...
                            {'example':'processes=5 random-baseline=False',
                    ...
                    'significance':[{'example':'demo',
                                     'description':'Compute significance for experiments of all modalities for the most recent run ID of a configuration at an alpha of 0.01. Requires that experiments have been executed with random embeddings.'},
