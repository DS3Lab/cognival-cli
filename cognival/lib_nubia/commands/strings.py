...
EXAMPLE_COMMANDS = {'config':{'open':[{'example':'config open myconfig',
                    ...
                    'significance':[{'example':'demo',
                                     'description':'Compute significance for experiments of all modalities for the most recent version of a configuration at an alpha of 0.01. Requires that experiments have been executed with random embeddings.'},
                                    {'example':'demo alpha=0.05',
                                     'description':'Likewise, but with a modified alpha.'},
                                    {'example':'configuration=demo version=1 modalities=[eye-tracking]',
                                     'description':'Compute significance for experiments of modality eye-tracking for version 1 of a configuration.'}],
                   ...
                   'report':[{'example':'report configuration=demo open-html=True',
                              'description':'Note: This command wraps significance and aggregate, thus sharing arguments of these commands.\n'
                                            'Compute significances, perform aggregation (all modalities, most recent version, default parameters), generates and opens HTML report (requires web browser and X11 forwarding when using SSH).'},
