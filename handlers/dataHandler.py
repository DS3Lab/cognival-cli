...
def chunker(input_path_name,
    ...
    df_wE = pd.read_csv(input_path / wordEmbedding, sep=" ",
    ...
    for i in range(0, chunk_number):
        ...
        df.to_csv(output_path / "{}_{}.txt".format(name, str(i)), sep=" ", encoding="utf-8")
